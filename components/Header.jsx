...
export default function Header() {
  return (
    <Flex direction='row' justify="space-between" p={"1%"} align="center">
      ...
      <Flex>
        <a href={"https://testnets.opensea.io/collection/nhl-predictions-mck0gor440"} target={"_blank"} rel="noreffer"><Text mr={"1rem"}>Opensea</Text></a>
        <a href={"https://etherscan.io/address/0xd8f3baa53d4541547a81453911183ccd0035c4f2"} target={"_blank"} rel="noreffer"><Text mr={"1rem"}>Contract</Text></a>
        <Popover>
          <PopoverTrigger>
