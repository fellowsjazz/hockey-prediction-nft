...
export default function DisplaySvg(props) {

const teamInfo = props.teamInfo;
const team = props.teamAbbr;
...
useEffect(()=>{
  ...
  <path d="M149 24a126 126 0 1 0 0 252 126 126 0 0 0 0-252Zm0 225.3a99.3 99.3 0 1 1 .1 0h-.1Z" fill="#000"/>
  ...
  <path id="b" d="M32 150a118 118 0 1 0 236 0 118 118 0 1 0-236 0" fill="none">
    <animateTransform attributeName="transform" begin="0s" dur="50s" type="rotate" from="0 150 150" to="360 150 150" repeatCount="indefinite"/>
  </path>
  <text dy="0" font-size="9" font-family="Arial" font-weight="900" fill="#fff" letter-spacing=".75">
        <textPath href="#b"> The {teamInfo[2]} will win the cup in 2023  /  Predicted by {address} on {month}-{day}-{year}</textPath> 
    </text>
      </svg>
    </Flex>
  );
