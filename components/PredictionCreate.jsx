...
export default function PredictionCreate() {
  const [selectedTeam, setSelectedTeam] = useState("CAR");
  ...
  return (
    <Flex direction={"column"} alignItems="center">
      <Flex direction={"row"} py="1%">
        <Center><Text fontSize={"xl"}>Mint Your Cup Pick</Text></Center>
        <Popover>
          <PopoverTrigger>
          ...
          <PopoverContent>
            ...
            <PopoverBody>
              Cup Pick is an on-chain NFT project that generates a unique collectible, incorporating your Ethereum address, your selected Stanley Cup Champion prediction, and the date the prediction was made!
              <br/>
              <br/>
  ...
  <Flex direction="column" align="center" w={"50%"} minW="300px" m={"1rem"}>
      <Text fontSize={"lg"} mb="5%">Which team do you think will win???</Text>
      ...
      <Center><Text as={"i"}>(Preview of your NFT)</Text></Center>
        <DisplaySvg
